...
export const config = {
  matcher: [
    "/((?!_next/static|_next/image|favicon.ico|robots.txt|sitemap.xml|sitemapindex-nexbit.xml|sitemap-nexbit-tr.xml|sitemap-nexbit-en.xml|sitemap-nexbit-hreflang.xml|assets|fonts|icons|images|globe.svg|file.svg|api).*)",
  ],
};
