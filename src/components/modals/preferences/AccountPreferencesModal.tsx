...
export function AccountPreferencesModal() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex shrink-0 items-center justify-between bg-primary px-6 py-4 h-14">
          <h3 className="text-base font-semibold text-white">{t("preferencesPage.title")}</h3>
          <button
            type="button"
            onClick={closeModal}
