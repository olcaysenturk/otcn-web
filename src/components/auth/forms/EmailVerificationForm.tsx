  ...
  return (
    <div>
      ...
      <h2 className="mb-3 text-3xl font-extrabold text-gray-900 lg:text-4xl">
        {t("auth.securityEmail.title")}
      </h2>
      <p className="mb-8 leading-relaxed text-gray-600">
        {t("auth.securityEmail.description").replace("{{email}}", email)}
      </p>
